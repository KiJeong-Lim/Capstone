...
void printManual()
{
    printf(
        ...
        "\r[#2 Key and action]\n"
        "\r  r                  = Start operation\n"
        "\r  b                  = Send p=0,v=0,kp=0,kd=0,t_ff=0\n"
        ...
        "\r  2                  = Let 2nd motor be rest\n"
        "\r  3                  = Let 3rd motor be rest\n"
        "\r  4                  = Let 4th motor be rest\n"
        "\r  5                  = Let 5th motor be rest\n"
        "\r  6                  = Let 6th motor be rest\n"
        "\r  l                  = Listen command\n"
