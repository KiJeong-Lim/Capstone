...
def write_ref_cpp(tbl_file, no):
    ...
    with open(tbl_file, 'w+') as tbl_txt:
        tbl_txt.write("#include \"capstone.hpp\"\n")
        tbl_txt.write("\n")
        tbl_txt.write("const Motor::PutData reftbl%i[][3] = {\n" % int(no))
        for i in range(m):
            tbl_txt.write("{ ")
            if 1 == 1:
                tbl_txt.write("{")
                tbl_txt.write(" .p = %lf," % p1[i])
                tbl_txt.write(" .v = %lf," % v1[i])
                tbl_txt.write(" .kp = %lf," % kp1[i])
                tbl_txt.write(" .kd = %lf," % kd1[i])
                tbl_txt.write(" .t_ff = %lf," % t1[i])
                tbl_txt.write(" }, ")
            if 2 == 2:
                tbl_txt.write("{")
                tbl_txt.write(" .p = %lf," % p2[i])
                tbl_txt.write(" .v = %lf," % v2[i])
                tbl_txt.write(" .kp = %lf," % kp2[i])
                tbl_txt.write(" .kd = %lf," % kd2[i])
                tbl_txt.write(" .t_ff = %lf," % t2[i])
                tbl_txt.write(" }, ")
            if 3 == 3:
                tbl_txt.write("{")
                tbl_txt.write(" .p = %lf," % p3[i])
                tbl_txt.write(" .v = %lf," % v3[i])
                tbl_txt.write(" .kp = %lf," % kp3[i])
                tbl_txt.write(" .kd = %lf," % kd3[i])
                tbl_txt.write(" .t_ff = %lf," % t3[i])
                tbl_txt.write(" }, ")
            tbl_txt.write("},\n")
        tbl_txt.write("};\n")
        tbl_txt.flush()
